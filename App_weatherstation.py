...
# Oauth JSON File
GDOCS_OAUTH_JSON       = 'unique-aloe-272503-6d674b224fe2.json'
...
while True:
	...
	temp = random.randint(30,40)#sense.get_temperature()
	#temp = round(temp, 1)
	humidity = random.randint(50,70)#sense.get_humidity()
	#humidity = round(humidity, 1)
	pressure = random.randint(1000,1200)#sense.get_pressure()
